[Youtube Link](https://youtu.be/bXDDBPPE9Ho) || [Colab](https://colab.research.google.com/drive/1cOsu8Wu5qaSVcEg7zTNYJu8o2hs9gwQq#scrollTo=cbdwazgdzfke)
...
## Analysis of Execution Times
  ...
  To ensure consistency in our profiling and debugging, we initialized the arrays with the constant value 7. This choice simplifies verification, as a uniform input allows for easy detection of anomalies in computation. Additionally, using 7 avoids numerical stability issues and ensures predictable patterns in memory access, making it easier to analyze execution behavior. Also, as a fun coincidence, our choice of 7 is justified by a simple equation: 21 (today’s date) ÷ 7 (lucky number) = 3 (our group number).
